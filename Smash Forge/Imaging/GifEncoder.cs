...
// Taken from https://github.com/DataDink/Bumpkit/blob/master/BumpKit/BumpKit/GifEncoder.cs
// All credit for the following code goes to the owner of the Bumpkit repo.
namespace SmashForge.Imaging
{
    /// <summary>
